...
public class ServerBackground {
	ServerSocket server;
	ServerUI gui;
	Map<String,DataOutputStream> ClientList; //!! 믈라이언트가 닉네임을 입려하면 outstream을 value로 해서 받음
	Socket client;
	...
	public void addClient(String nick, DataOutputStream Dout) { //입력?
	...
	public void broadCast(String msg) {//내용 송출
